      ...
      <button
        ...
        className={`w-full flex items-center justify-center px-6 py-3.5 text-base font-medium rounded-xl transition-all duration-300 ${
          isValid && !isSubmitting
            ? "cursor-pointer bg-gradient-to-r from-blue-600 to-blue-700 dark:from-blue-500 dark:to-blue-600 text-white hover:from-blue-700 hover:to-blue-800 dark:hover:from-blue-600 dark:hover:to-blue-700 focus:ring-4 focus:ring-blue-100 dark:focus:ring-blue-900 transform hover:-translate-y-0.5 shadow-lg hover:shadow-xl"
